#!/usr/bin/env python3
"""Feature test for the Scribbolyth export command :x (export_scribbolyth).
...
DATA_DIR = '/tmp/scribbolyth_tests/x_export_data'
shutil.rmtree(DATA_DIR, ignore_errors=True)
os.makedirs(DATA_DIR)

SUB = os.path.join(DATA_DIR, 'alpha.scribboleth')
